...
var px_context_navigation_panel_1;
...
document.addEventListener("WebComponentsReady", function() {
  var contextBrowser = document.querySelector('#px_context_navigation_panel_1');
...
function runBaseTests() {
  px_context_navigation_panel_1 = document.getElementById('px_context_navigation_panel_1');

  px_context_navigation_panel_1.browserContext = browserContext;

  suite('Base Automation Tests for px-context-navigation-nael', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-context-navigation-panel fixture is created', function() {
      assert.isTrue(document.getElementById('px_context_navigation_panel_1') !== null);
    });
